...
def demonstrate_qdrant_operations():
    ...
    with start_span("qdrant_demo"):
        try:            
            ...
            # Upsert points
            points = [
                PointStruct(id=1, vector=[0.1] * 128, payload={"source": "test", "category": "demo"}),
                PointStruct(id=2, vector=[0.2] * 128, payload={"source": "test", "category": "demo"}),
                PointStruct(id=3, vector=[0.3] * 128, payload={"source": "test", "category": "demo"}),
                PointStruct(id=4, vector=[0.4] * 128, payload={"source": "test", "category": "demo"})
            ]
...
if __name__ == "__main__":
    ...
    print("- db.operation: 'create_collection', 'upsert', 'search', 'retrieve', 'set_payload', 'delete', 'get_collection'")
