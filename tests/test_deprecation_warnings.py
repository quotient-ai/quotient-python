...
def async_quotient_client_with_mock_resource(mock_logs_resource):
    ...
    with patch("quotientai.async_client._AsyncQuotientClient") as MockClient, \
         patch("quotientai.resources.auth.AsyncAuthResource") as MockAuthResource:
        mock_instance = MockClient.return_value
...
class TestSyncDeprecationWarnings:
    ...
    def test_deprecated_params_in_logger_init_triggers_warning(self, quotient_client_with_mock_resource):
    ...
    def test_deprecated_params_in_logger_init_with_inconsistency_detection(self, quotient_client_with_mock_resource):
    ...
    def test_mixing_deprecated_and_new_params_in_logger_init_fails(self, quotient_client_with_mock_resource, caplog):
    ...
    def test_deprecated_params_in_log_method_triggers_warning(self, quotient_client_with_mock_resource):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert issubclass(w[0].category, DeprecationWarning)
            assert "deprecated as of 0.3.4" in str(w[0].message)
            assert "Document relevancy is not available with deprecated parameters" in str(w[0].message)
            
            # Verify log was still created
            assert log_id == "test-log-id"

    def test_mixing_deprecated_and_new_params_in_log_method_fails(self, quotient_client_with_mock_resource, caplog):
    ...
    def test_deprecated_params_require_user_query_and_model_output(self, quotient_client_with_mock_resource, caplog):
        ...
        assert log_id is None
        assert "user_query and model_output are required when using deprecated parameters" in caplog.text
...
class TestAsyncDeprecationWarnings:
    ...
    def test_deprecated_params_in_async_logger_init_triggers_warning(self, async_quotient_client_with_mock_resource):
    ...
    @pytest.mark.asyncio
    async def test_deprecated_params_in_async_log_method_triggers_warning(self, async_quotient_client_with_mock_resource):
    ...
    def test_mixing_deprecated_and_new_params_in_async_logger_init_fails(self, async_quotient_client_with_mock_resource, caplog):
    ...
    @pytest.mark.asyncio
    async def test_mixing_deprecated_and_new_params_in_async_log_method_fails(self, async_quotient_client_with_mock_resource, caplog):
    ...
    @pytest.mark.asyncio
    async def test_new_params_work_without_warnings_async(self, async_quotient_client_with_mock_resource):
...
class TestDeprecationWarningMessages:
    ...
    def test_warning_message_content_in_log(self, quotient_client_with_mock_resource):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert "Document relevancy is not available with deprecated parameters" in warning_message
